      ...
      images: [
        {
          ...
          alt: "Artisan Metal Jewelry Showcase",
          captionTh: "ตู้จัดแสดงผลงานเครื่องประดับโลหะและเครื่องเงินเคาะดุนลายมิติสูง",
          captionEn: "Curated exhibition showcase of handcrafted chased metal and silver jewelry",
          captionFr: "Vitrine d'exposition de haute joaillerie en métal et argent ciselé",
        },
        {
          src: "/images/craft-expertise/texturing/img_2.jpg",
          alt: "Textured Silver & Brass Earrings Catalog",
          captionTh: "ชุดต่างหูเงินแท้และทองเหลืองเคาะลายพื้นผิว ผิวสัมผัสโลหะดิบร่วมสมัย",
          captionEn: "Catalog suite of textured sterling silver and brass statement earrings",
          captionFr: "Suite de boucles d'oreilles en argent massif et laiton texturés",
        },
        {
          src: "/images/craft-expertise/texturing/img_3.jpg",
          alt: "Haute Metal Statement Jewelry on Runway",
          captionTh: "ผลงานเครื่องประดับโลหะเคาะดุนลายสวมใส่จริง โดดเด่น สง่างาม และน้ำหนักเบา",
          captionEn: "Runway editorial featuring bold yet featherweight hammered metal statement jewelry",
          captionFr: "Éditorial de mode arborant des bijoux de caractère sculptés en métal ultra-léger",
        },
        {
          src: "/images/craft-expertise/texturing/img_4.jpg",
          alt: "Artisan Craft Award Recognition",
          captionTh: "ความภาคภูมิใจกับการได้รับเกียรติบัตรรับรองความเป็นเลิศด้านงานหัตถศิลป์เครื่องประดับ",
          captionEn: "Award ceremony recognizing mastery and innovation in contemporary jewelry craft",
          captionFr: "Remise de prix récompensant l'excellence et l'innovation en joaillerie d'art",
        },
        {
          src: "/images/craft-expertise/texturing/img_5.jpg",
          alt: "Master Craftsman with Fine Jewelry Creation",
          captionTh: "อาจารย์ผู้รังสรรค์กับผลงานเครื่องประดับเคาะลายในงานนิทรรศการระดับพรีเมียม",
          captionEn: "Master artisan presenting handcrafted repoussé jewelry collection at prestigious gala",
          captionFr: "Maître artisan présentant sa collection de bijoux repoussés lors d'une exposition",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Artisan Coiled Wire Drop Earrings",
          captionTh: "ต่างหูดัดลวดเงินแท้พันเกลียวลายก้นหอยผสานเม็ดพลอยสีธรรมชาติ",
          captionEn: "Hand-coiled sterling silver spiral drop earrings with natural accent beads",
          captionFr: "Boucles d'oreilles pendantes en argent massif torsadé et perles de couleur",
        },
        {
          src: "/images/craft-expertise/wire-work/img_2.jpg",
          alt: "Delicate Wire Link Gemstone Bracelets",
          captionTh: "สร้อยข้อมือโซ่ลวดเงินดัดมือประดับหินสีมงคลหลากชนิด",
          captionEn: "Handmade fine wire link charm bracelets with delicate chakra mineral beads",
          captionFr: "Bracelets en chaîne de fil d'argent façonnée à la main avec minéraux subtils",
        },
        {
          src: "/images/craft-expertise/wire-work/img_3.jpg",
          alt: "Sculptural Wire Wrapped Mineral Pendant",
          captionTh: "สร้อยคอถักลวดเงินโอบอุ้มหินมูนสโตนและลูกปัดแร่ออร์แกนิก",
          captionEn: "Sculptural silver wire setting cradling natural moonstone and earthy minerals",
          captionFr: "Pendentif sculpté en fil d'argent sertissant une pierre de lune naturelle",
        },
        {
          src: "/images/craft-expertise/wire-work/img_4.jpg",
          alt: "Spiral Coiled Wire Mandala Earrings",
          captionTh: "ต่างหูขดลวดทรงก้นหอยมันดาลา ประดับลูกปัดคริสตัลระยิบระยับ",
          captionEn: "Vortex spiral coiled wire mandala earrings accented with faceted crystals",
          captionFr: "Boucles d'oreilles mandala en fil enroulé en spirale ornées de cristaux",
        },
        {
          src: "/images/craft-expertise/wire-work/img_5.jpg",
          alt: "Sacred Spiral Wire Wrapped Pendant",
          captionTh: "จี้ดัดลวดเงินลายก้นหอยศักดิ์สิทธิ์และพู่ลูกปัดอัญมณีล้ำค่า",
          captionEn: "Sacred spiral silver wire talisman pendant with cascading gemstone drops",
          captionFr: "Pendentif talisman en filigrane d'argent à spirale sacrée et gouttes de gemmes",
        },
        {
          src: "/images/craft-expertise/wire-work/img_6.jpg",
          alt: "Curated Wire Work Drop Earrings Suite",
          captionTh: "คอลเลกชันต่างหูดัดลวดเงินแฮนด์เมดหลากดีไซน์ สวมใส่ง่ายทุกโอกาส",
          captionEn: "Curated collection of artisan wire formed drop earrings in versatile silhouettes",
          captionFr: "Collection de boucles d'oreilles pendantes en fil artisanal aux silhouettes variées",
        },
        {
          src: "/images/craft-expertise/wire-work/img_7.jpg",
          alt: "Intricate Gemstone Cage Wire Setting",
          captionTh: "งานถักลวดโอบรับผลึกแร่ธรรมชาติแบบไร้รอยบัดกรี (Solderless Cage)",
          captionEn: "Complex solderless wire cage locking raw crystal minerals into wearable art",
          captionFr: "Sertissage en cage de fil métallique sans soudure maintenant des cristaux bruts",
        },
        {
          src: "/images/craft-expertise/wire-work/img_8.jpg",
          alt: "Sculptural Wire Wrapped Cuff Bracelet",
          captionTh: "กำไลข้อมือดัดลวดเส้นสายสถาปัตยกรรม มั่นคง แข็งแรง และอ่อนช้อย",
          captionEn: "Architectural wire sculpted cuff bracelet balancing structural strength with elegance",
          captionFr: "Bracelet manchette sculpté en fil architectural mariant robustesse et élégance",
        },
        {
          src: "/images/craft-expertise/wire-work/img_9.jpg",
          alt: "Layered Wire Weaving & Texturing Feature",
          captionTh: "งานถักทอเส้นลวดโลหะซ้อนชั้นมิติสูง ผสมผสานเทคนิคการดัดและพันเกลียว",
          captionEn: "Multi-layered metal wire weaving combining precision tension wrapping and coiling",
          captionFr: "Tissage métallique multi-couches combinant enroulement sous tension et torsades",
        },
        {
          src: "/images/craft-expertise/wire-work/img_10.jpg",
          alt: "Fine Wire Filigree Adornment",
          captionTh: "เครื่องประดับลวดดัดลวดลายฟิลิกรี (Filigree) งานประณีตศิลป์ระดับพรีเมียม",
          captionEn: "Artisanal wire filigree jewelry demonstrating refined micro-dexterity",
          captionFr: "Bijou en filigrane artisanal démontrant une micro-dextérité raffinée",
        },
        {
          src: "/images/craft-expertise/wire-work/img_11.jpg",
          alt: "Masterpiece Wire Sculpting Collection",
          captionTh: "ชุดงานคราฟต์เครื่องประดับ Wire Work ระดับมาสเตอร์พีซของแบรนด์ Armada",
          captionEn: "Masterpiece Wire Work artisan jewelry suite celebrating pure metal craft",
          captionFr: "Parure chef-d'œuvre de bijouterie d'art Wire Work célébrant l'artisanat du métal",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Purple Harmonic Chromatic Thread Jewelry Suite",
          captionTh: "ชุดสร้อยคอและต่างหูพันเส้นด้ายเฉดสีม่วงมาเจนต้า ผสานพู่ไหมร่วมสมัย",
          captionEn: "Magenta and violet chromatic thread statement necklace suite with silk tassel",
          captionFr: "Parure collier et boucles d'oreilles en fil chromatique magenta et pompon de soie",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_2.jpg",
          alt: "Mint & Obsidian Thread Wrapped Necklace Set",
          captionTh: "ชุดเครื่องประดับพันเส้นด้ายโทนสีเขียวมิ้นท์และสีดำ เรียบหรูสไตล์โมเดิร์น",
          captionEn: "Mint green and obsidian black thread wrapped collar necklace set",
          captionFr: "Ensemble collier plastron en fil enroulé vert menthe et noir obsidienne",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_3.jpg",
          alt: "Coral Pink Tassel Thread Wrapped Collar",
          captionTh: "สร้อยคอพันเส้นด้ายเฉดสีชมพูคอรัลและทองเหลือง เพิ่มความสดใสและพลังบวก",
          captionEn: "Coral pink and brass accented thread wrapped collar on display bust",
          captionFr: "Collier ras-de-cou en fil enroulé rose corail avec accents de laiton",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_4.jpg",
          alt: "Artisan Patterned Chromatic Thread Bangles",
          captionTh: "กำไลข้อมือพันเส้นด้ายลายเกลียวเรขาคณิตคู่สีตัดกันอย่างมีเอกลักษณ์",
          captionEn: "Pair of geometric spiraled chromatic thread bangles with metallic accents",
          captionFr: "Paire de bracelets joncs géométriques en fils chromatiques torsadés",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_5.jpg",
          alt: "Teardrop Thread Wrapped Tassel Earrings",
          captionTh: "ต่างหูหยดน้ำพันเส้นด้ายหลากสีผสานพู่ไหม สะบัดพลิ้วไหวสง่างาม",
          captionEn: "Teardrop shaped multi-hued thread wrapped earrings with fluid fringe tassels",
          captionFr: "Boucles d'oreilles goutte d'eau en fil multicolore avec franges fluides",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_6.jpg",
          alt: "Curated Bohemian Chromatic Thread Bangles & Earrings",
          captionTh: "คอลเลกชันกำไลและต่างหูพันเส้นด้ายคู่สีชนเผ่าโบฮีเมียนร่วมสมัย",
          captionEn: "Curated bohemian chromatic thread bangles and dangling tassel earrings collection",
          captionFr: "Collection de joncs et boucles d'oreilles bohèmes en fils chromatiques",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_7.jpg",
          alt: "Dynamic Geometric Fiber Collar",
          captionTh: "สร้อยคอโครงสร้างเส้นด้ายเรขาคณิตผสมผสานการไล่เฉดสีทฤษฎีคู่สี",
          captionEn: "Dynamic geometric fiber collar exploring Color Harmony gradient calibration",
          captionFr: "Collier géométrique en fibres explorant les dégradés de l'Harmonie des Couleurs",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_8.jpg",
          alt: "Artisan Multi-cord Thread Bracelets",
          captionTh: "ชุดสร้อยข้อมือพันด้ายหลากสีสัน น้ำหนักเบา สวมใส่สบายในทุกวัน",
          captionEn: "Multi-cord handcrafted chromatic thread bracelets for everyday luxury wear",
          captionFr: "Bracelets multi-cordons artisanaux en fils chromatiques légers et confortables",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_9.jpg",
          alt: "Precision Wrapped Mandala Fiber Earrings",
          captionTh: "ต่างหูทรงกลมพันเส้นด้ายเรขาคณิตมิติซ้อน สะท้อนพลังงานและความสมดุล",
          captionEn: "Concentric mandala fiber disc earrings radiating balance and chromatic energy",
          captionFr: "Boucles d'oreilles disques mandala concentriques rayonnant d'énergie chromatique",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_10.jpg",
          alt: "Vibrant Statement Fiber Choker",
          captionTh: "โชคเกอร์พันเส้นด้ายเฉดสีสดใส โดดเด่นบนเรือนร่างด้วยดีไซน์เฉพาะตัว",
          captionEn: "Vibrant statement fiber choker sculpted with precision thread tensioning",
          captionFr: "Ras-de-cou sculptural en fibres éclatantes façonné avec tension de fil précise",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_11.jpg",
          alt: "Chromatic Color Wave Jewelry Set",
          captionTh: "ชุดเครื่องประดับเส้นด้ายคลื่นสีโมเดิร์น ผสานศิลปะหัตถกรรมเข้ากับแฟชั่นร่วมสมัย",
          captionEn: "Contemporary chromatic wave jewelry suite merging heritage fiber craft with haute fashion",
          captionFr: "Parure textile en vagues chromatiques fusionnant artisanat et haute couture",
        },
        {
          src: "/images/craft-expertise/chromatic-thread/img_12.jpg",
          alt: "Masterpiece Chromatic Thread Collection",
          captionTh: "คอลเลกชันงานคราฟต์ Chromatic Thread ระดับมาสเตอร์พีซ นวัตกรรมศิลปะเส้นด้ายของ Armada",
          captionEn: "Masterpiece Chromatic Thread collection showcasing proprietary fiber architecture",
          captionFr: "Collection chef-d'œuvre Chromatic Thread illustrant l'architecture textile exclusive",
        },
      ],
    },
    {
      ...
      images: [
        {
          ...
          alt: "Colorful Micro Macramé Pendants Display",
          captionTh: "จี้และสร้อยคอไมโครมาคราเม่หลากสีสัน ลวดลายพัดและดอกไม้เรขาคณิต",
          captionEn: "Vibrant micro macramé fan and mandala pendant necklaces collection",
          captionFr: "Pendentifs mandala et éventail vibrants en micro-macramé faits main",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_2.jpg",
          alt: "Intricate Micro Macramé Collar Chokers",
          captionTh: "สร้อยคอโชคเกอร์ถักปมไมโครมาคราเม่ระดับพรีเมียม ลวดลายลูกไม้เรขาคณิตซับซ้อน",
          captionEn: "Haute artisan micro macramé choker collars woven with intricate geometric lace",
          captionFr: "Ras-de-cou de haute joaillerie en micro-macramé aux dentelles géométriques",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_3.jpg",
          alt: "Master Artisan Precision Micro-Knotting Technique",
          captionTh: "กระบวนการผูกปมเส้นเชือกจิ๋วด้วยมือทีละปม ความละเอียดระดับมิลลิเมตร",
          captionEn: "Master artisan millimeter-scale manual micro knotting process on weaving cushion",
          captionFr: "Processus artisanal de micro-nouage millimétrique sur coussin de travail",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_4.jpg",
          alt: "Artisan Micro Macramé Showcase Booth",
          captionTh: "บรรยากาศการจัดแสดงผลงานเครื่องประดับ Micro Macramé ในงานอีเวนต์ระดับพรีเมียม",
          captionEn: "Artisan exhibition booth showcasing curated micro macramé statement jewelry",
          captionFr: "Stand d'exposition présentant des bijoux de caractère en micro-macramé",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_5.jpg",
          alt: "Curated Micro Macramé Mandala Collection",
          captionTh: "คอลเลกชันเครื่องประดับและงานถักมันดาลาไมโครมาคราเม่ สีสันสดใสและทรงพลัง",
          captionEn: "Extensive curated collection of colorful micro macramé mandala wristlets and accessories",
          captionFr: "Vaste collection d'accessoires et bracelets mandala colorés en micro-macramé",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_6.jpg",
          alt: "Micro Macramé Masterclass & Workshop",
          captionTh: "เวิร์กช็อปและมาสเตอร์คลาสถ่ายทอดศิลปะการผูกปม Micro Macramé โดยช่างฝีมือชั้นครู",
          captionEn: "Interactive micro macramé artisan masterclass and jewelry styling session",
          captionFr: "Atelier et masterclass de formation aux techniques ancestrales du micro-macramé",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_7.jpg",
          alt: "Gemstone Mechanical Bezel Micro Macramé Setting",
          captionTh: "งานถักเชือกโอบอุ้มหินธรรมชาติด้วยระบบล็อกเชิงกลโดยไม่ต้องพึ่งพากาว",
          captionEn: "Adhesive-free mechanical gem bezel setting woven with high-tensile micro cords",
          captionFr: "Sertissage mécanique de gemme sans colle tressé en micro-cordons haute résistance",
        },
        {
          src: "/images/craft-expertise/micro-macrame/img_8.jpg",
          alt: "Masterpiece Micro Macramé Haute Adornment Suite",
          captionTh: "ชุดเครื่องประดับ Micro Macramé ระดับมาสเตอร์พีซ ศิลปะแห่งความประณีตระดับสากล",
          captionEn: "Masterpiece haute jewelry micro macramé suite celebrating supreme manual dexterity",
          captionFr: "Parure chef-d'œuvre de haute joaillerie en micro-macramé d'exception",
        },
      ],
    },
    {
